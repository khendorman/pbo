...
public class form_master extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "JAWA TIMUR", "JAWA TENGAH", "JAWA BARAT", "JAKARTA" }));
...
//        jTextArea1.append("Provinsi: "+jTextField2.getText()+"\n");
        jTextArea1.append("Provinsi: "+jComboBox1.getSelectedItem().toString()+"\n");
        if(jRadioButton1.isSelected()==true){
            jTextArea1.append("Sex: Male" +"\n");
        }   else if(jRadioButton2.isSelected()==true){
            jTextArea1.append("Sex: Female" +"\n");
        }
        jTextArea1.append("Hobby: ");
        if (jCheckBox1.isSelected()==true){
            jTextArea1.append("sepak bola" +"\n");
        }   else if(jCheckBox2.isSelected()==true){
            jTextArea1.append("basket" +"\n");
        }   else if(jCheckBox3.isSelected()==true){
            jTextArea1.append("voly" +"\n");
        }
